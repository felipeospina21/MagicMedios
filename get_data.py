...
def get_data(url, search_box_id, first_result_xpath, header_xpath, title_index, sub_title_index,
    ...
    for reference in ref_list:
        ...
        # Revisar como estandarizar, todos los prosedimientos tienen esta parte diferente
        try:
